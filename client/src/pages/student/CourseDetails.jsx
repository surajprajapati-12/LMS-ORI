...
const CourseDetails = () => {
  ...
  className="absolute top-0 left-0 w-full section-height -z-10 bg-gradient-to-b from-cyan-100/70 " />
      {/* left column */}
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className="course-details-heading-small md:course-details-heading-large font-semibold text-gray-800">
  {courseData.courseTitle}
         ...
         dangerouslySetInnerHTML={{__html : courseData.courseDescription.slice(0,200)}}></p>
           ...
           {/*review and rating*/}
            <div className='flex items-center space-x-2 pt-3 pb-1 text-sm '>
                   ...
                   <p className='text-sm'>Course by <span className='text-blue-600 underline'>SurajPrajapati</span></p>
      ...
      {/* right column */}
      <div className='max-w-course-card z-10 shadow-cutom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
         {
              playerData ?
        ...
        <div className='p-5'>
          <div className='flex items-center gap-2'>
            ...
            alt=" time ledt clock icon" />
            

            
            <p className='text-red-500'><span className='font-medium'> 5 days</span>a left at this price </p>
          </div>
...
<button
  className={`md-mt mt-4 w-full py-3 rounded text-white font-medium 
...
<div className='pt-6'>
  <p className='md:text-xl text-lg font-medium text-gray-800'>What is the course?
